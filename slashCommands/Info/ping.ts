...
module.exports = {
    ...
    async execute(interaction: CommandInteraction, client: any, footers: string[]) {
        ...
        const fieldMessages = await client.getLocale(interaction.user.id, "commands.info.ping.fieldMsg")
        ...
        embed.setTitle("Pong!")
        embed.setDescription(await client.getLocale(interaction.user.id, "commands.info.ping.embedDesc", ping, client.ws.ping));
