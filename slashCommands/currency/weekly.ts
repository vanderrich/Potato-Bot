...
module.exports = {
    ...
    async execute(interaction: CommandInteraction, client: any) {
        ...
        if (addMoney.error) return interaction.reply(await client.getLocale(interaction.user.id, "commands.currency.rewards.cooldown", await client.getLocale(interaction.user.id, "commands.currency.rewards.weekly"), addMoney.time));
