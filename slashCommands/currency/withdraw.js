...
module.exports = {
    ...
    execute(interaction, client) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let result = yield client.eco.withdraw({
            ...
            if (result.error) {
                ...
                if (result.type === 'low-money')
                    return interaction.reply("You don't have that much money in your bank.");
                if (result.type === 'bank-full')
                    return interaction.reply("Your bank is empty.");
            }
            else {
                if (result.type === 'all-success')
                    return interaction.reply("You have withdrawn all your money to your bank" + `\nNow you have **$${result.rawData.wallet}** in your wallet and **$${result.rawData.bank}** in your bank.`);
                if (result.type === 'success')
                    return interaction.reply(`You have withdrawn **$${result.amount}** to your bank.\nNow you have **$${result.rawData.wallet}** in your wallet and **$${result.rawData.bank}** in your bank.`);
            }
            ;
        });
    }
