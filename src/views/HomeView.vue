...
<template>
    <div class="wrapper">
        <h1>Potato Bot</h1>
        <h3>Your local general purpose bot.</h3>
        <h3>
            Created by
            <a href="https://discordapp.com/users/709950767670493275">vanderrich#9982</a>.
        </h3>
        <div id="thing">
            <!--border thing-->
            ...
            <div id="features">
                ...
                <div id="moderation" class="feature">
                    <h3>Moderation</h3>
                    <p>
                ...
                <div id="giveaways" class="feature">
                    <h3>Giveaways</h3>
