    ...
    execute(reaction, user, client) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!reactionEmojiIndex || reactionEmojiIndex == -1)
                return;
            try {
                (_c = (_b = reaction.message.guild) === null || _b === void 0 ? void 0 : _b.members.cache.get(user.id)) === null || _c === void 0 ? void 0 : _c.roles.add(reactionRole.roleId[reactionEmojiIndex]);
